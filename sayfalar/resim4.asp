                ...
                <main>
                    ...
                    <CENTER>
                        <a class="fotograf" href="">
                            <img src="../resimler/resim4.jpg" alt="" class="img2">
                        </a>
                    </CENTER>
                    <section class="sectionKisi">
                        <div class="forum2">
                            <div class="row">
                                <form action="resim4.asp" method="POST">
                                    <a href="resim44.asp">Bu resim hakkında  mesaj / yorum ekleyin..  :)</a>    
                                </form>       
                            </div>
                        </div> 
                    </section>
                    <div class="sectionKisi">
                        ...
                        <% 
                            ...
                            sql="select * from resim4"
                            veri.Open "resim4", conn
                        %>
...
<%
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO resim4(tarih,saat,isim,yorum) VALUES('"& tarih & "','"& saat & "','"& isim & "','"& message & "')"
        conn.Execute sql 
    
        conn.Close 
        set conn=Nothing

        response.redirect "resim4.asp"
    end if
%>