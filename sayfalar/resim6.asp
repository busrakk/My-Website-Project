                ...
                <main>
                    ...
                    <CENTER>
                        <a class="fotograf" href="">
                            <img src="../resimler/resim6.jpg" alt="" class="img2">
                        </a>
                    </CENTER>
                    <section class="sectionKisi">
                        <div class="forum2">
                            <div class="row">
                                <form action="resim6.asp" method="POST">
                                    <a href="resim66.asp">Bu resim hakkında  mesaj / yorum ekleyin..  :)</a>    
                                </form>  
                            </div>
                        </div> 
                    </section>
                    <div class="sectionKisi">
                        ...
                        <% 
                            ...
                            sql="select * from resim6"
                            veri.Open "resim6", conn
                        %>
...
<%
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO resim6(tarih,saat,isim,yorum) VALUES('"& tarih & "','"& saat & "','"& isim & "','"& message & "')"
        conn.Execute sql 
    
        conn.Close 
        set conn=Nothing

        response.redirect "resim6.asp"
    end if
%>