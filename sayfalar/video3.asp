    ...
    <body>
        ...
        <div id="container">
            ...
            <section>
                ...
                <main>
                    <h1> Yozgat Tanıtım Videosu </h1>
                    <CENTER>
                        <a class="fotograf" href="">
                            
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/zv1LrEouC-A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            
                            <!--<video src="../resimler/video1.mp4" alt="" class="img2">-->
                        </a>
                    </CENTER>
                        ...
                        <div class="forum2">
                            <div class="row">
                                    <form action="video3.asp" method="POST">
                                        <a href="video33.asp">Bu video hakkında  mesaj / yorum ekleyin..  :)</a>    
                                    </form>       
                            </div>
                        </div> 
                    </section>
...
<%
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO video3(tarih,saat,isim,yorum) VALUES('"& tarih & "','"& saat & "','"& isim & "','"& message & "')"
        conn.Execute sql 
    
        conn.Close 
        set conn=Nothing

        response.redirect "video3.asp"
    end if
%>
