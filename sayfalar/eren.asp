                ...
                <main>
                    ...
                    <CENTER>
                        <section class="section1">
                            <div class="sayfa">
                                <div class="img">
                                    <img src="../resimler/eren.jpg" alt="" class="img1">
                                </div>
                                <div class="bilgi">
                                    <span class="span1">
                                        Diş Hekimi
                            ...
                            <section class="sectionKisi">
                                <div class="forum1">
                                    <div class="row">
                                        <form action="eren.asp" method="POST">
                                            <a href="eren1.asp">Erencan Yazan hakkında yazınız.. :)</a>
                                        </form> 
                                    </div>
                                </div> 
                            </section>
...
<%
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO eren(tarih,saat,isim,yorum) VALUES('"& tarih & "','"& saat & "','"& isim & "','"& message & "')"
        conn.Execute sql 
    
        conn.Close 
        set conn=Nothing

        response.redirect "eren.asp"
    end if
%>