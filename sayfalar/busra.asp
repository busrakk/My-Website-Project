                ...
                <main>
                    ...
                    <CENTER>
                        <section class="section1">
                            <div class="sayfa">
                                <div class="img">
                                    <img src="../resimler/busra.jpg" alt="" class="img1">
                                </div>
                                <div class="bilgi">
                                    <span class="span1">
                            ...
                            <section class="sectionKisi">
                                <div class="forum1">
                                    <div class="row">
                                        <form action="busra.asp" method="POST">
                                            <a href="busra1.asp">Büşra Kartal hakkında yazınız.. :)</a>
                                        </form>       
                                    </div>
                                </div> 
                            </section>
                            <div class="sectionKisi">
                                ...
                                <% 
                                    ...
                                    sql="select * from busra"
                                    veri.Open "busra", conn
                                %>
...
<%
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO busra(tarih,saat,isim,yorum) VALUES('"& tarih & "','"& saat & "','"& isim & "','"& message & "')"
        conn.Execute sql 
    
        conn.Close 
        set conn=Nothing

        response.redirect "busra.asp"
    end if
%>