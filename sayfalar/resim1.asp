                ...
                <main>
                    ...
                    <CENTER>
                        <a class="fotograf" href="">
                            <img src="../resimler/ilk.jpg" alt="" class="img2">
                        </a>
                    </CENTER>
                    <section class="sectionKisi">
                        <div class="forum2">
                            <div class="row">
                                    <form action="resim1.asp" method="POST">
                                        <a href="resim11.asp">Bu resim hakkında  mesaj / yorum ekleyin..  :)</a>    
                                    </form>       
                            </div>
                        </div> 
                    </section>
                    <div class="sectionKisi">
                        ...
                        <% 
                            ...
                            sql="select * from resim1"
                            veri.Open "resim1", conn
                        %>
...
<%
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO resim1(tarih,saat,isim,yorum) VALUES('"& saat & "','"& isim & "','"& message & "')"
        conn.Execute sql 
    
        conn.Close 
        set conn=Nothing

        response.redirect "resim1.asp"
    end if
%>