                    ...
                    <CENTER>
                        <a class="fotograf" href="">
                            <video width="620" height="440" controls>
                                <source src="../resimler/video2.mp4" type="video/mp4">
                            </video>
                        ...
                        <div class="forum2">
                            <div class="row">
                                    <form action="video2.asp" method="POST">
                                        <a href="video22.asp">Bu video hakkında  mesaj / yorum ekleyin..  :)</a>    
                                    </form>       
                            </div>
                        </div> 
                    </section>
...
<%
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO video2(tarih,saat,isim,yorum) VALUES('"& tarih & "','"& saat & "','"& isim & "','"& message & "')"
        conn.Execute sql 
