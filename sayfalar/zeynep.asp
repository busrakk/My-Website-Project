                ...
                <main>
                    ...
                    <CENTER>
                        <section class="section1">
                            <div class="sayfa">
                                <div class="img">
                                    <img src="../resimler/zeynep.jpg" alt="" class="img1">
                                </div>
                                <div class="bilgi">
                                    <span class="span1">
                                        Hemşire
                            ...
                            <section class="sectionKisi">
                                <div class="forum1">
                                    <div class="row">
                                        <form action="zeynep.asp" method="POST">
                                            <form action="zeynep.asp" method="POST">
                                                <a href="zeynep1.asp">Zeynep Ergün hakkında yazınız.. :)</a>
                                            </form>     
                                        </form>       
                                    </div>
                                </div> 
                            ...
                            <div class="sectionKisi">
                                ...
                                <% 
                                    ...
                                    sql="select * from zeynep"
                                    veri.Open "zeynep", conn
                                %>
...
<%
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO zeynep(tarih,saat,isim,yorum) VALUES('"& tarih & "','"& saat & "','"& isim & "','"& message & "')"
        conn.Execute sql 
    
        conn.Close 
        set conn=Nothing

        response.redirect "zeynep.asp"
    end if
%>