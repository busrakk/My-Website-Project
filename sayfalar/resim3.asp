                ...
                <main>
                    ...
                    <CENTER>
                        <a class="fotograf" href="">
                            <img src="../resimler/resized_resim3.jpg" usemap="#workmap" class="resized">
                            <map name="workmap">
                                <area shape="rect" href="../sayfalar/busra.asp" coords="305,226,341,256" alt="busra" title="Büşra Kartal" >
                                <area shape="rect" href="../sayfalar/irem.asp" coords="349,178,408,222" alt="irem" title="İrem Yıldırım" >
                                <area shape="rect" href="../sayfalar/eren.asp" coords="478,84,559,173" alt="eren" title="Erencan Yazan" >
                              </map>
                        </a>
                    </CENTER>
                    <section class="sectionKisi">
                        <div class="forum2">
                            <div class="row">
                                <form action="resim3.asp" method="POST">
                                    <a href="resim33.asp">Bu resim hakkında  mesaj / yorum ekleyin..  :)</a>    
                                </form>  
                            </div>
                        </div> 
                    </section>
                    <div class="sectionKisi">
                        ...
                        <% 
                            ...
                            sql="select * from resim3"
                            veri.Open "resim3", conn
                        %>
...
<%
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO resim3(tarih,saat,isim,yorum) VALUES('"& tarih & "','"& saat & "','"& isim & "','"& message & "')"
        conn.Execute sql 
    
        conn.Close 
        set conn=Nothing

        response.redirect "resim3.asp"
    end if
%>