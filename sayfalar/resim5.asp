                ...
                <main>
                    ...
                    <CENTER>
                        <a class="fotograf" href="">
                            <img src="../resimler/resim5.jpg" alt="" class="img2">
                        </a>
                    </CENTER>
                    <section class="sectionKisi">
                        <div class="forum2">
                            <div class="row">
                                <form action="resim5.asp" method="POST">
                                    <form action="resim5.asp" method="POST">
                                        <a href="resim55.asp">Bu resim hakkında  mesaj / yorum ekleyin..  :)</a>    
                                    </form>
                                </form>       
                            </div>
                        </div> 
                    ...
                    <div class="sectionKisi">
                        ...
                        <% 
                            ...
                            sql="select * from resim5"
                            veri.Open "resim5", conn
                        %>
...
<%
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO resim5(tarih,saat,isim,yorum) VALUES('"& tarih & "','"& saat & "','"& isim & "','"& message & "')"
        conn.Execute sql 
    
        conn.Close 
        set conn=Nothing

        response.redirect "resim5.asp"
    end if
%>