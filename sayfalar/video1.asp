                        ...
                        <div class="forum2">
                            <div class="row">
                                    <form action="video1.asp" method="POST">
                                        <a href="video11.asp">Bu video hakkında  mesaj / yorum ekleyin..  :)</a>    
                                    </form>       
                            </div>
                        </div> 
                    </section>
...
<%
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO video1(tarih,saat,isim,yorum) VALUES('"& tarih & "','"& saat & "','"& isim & "','"& message & "')"
        conn.Execute sql 
