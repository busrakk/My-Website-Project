                ...
                <main>
                    ...
                    <CENTER>
                        <a class="fotograf" href="">
                            <img src="../resimler/resim7.jpg" alt="" class="img2">
                        </a>
                    </CENTER>
                    <section class="sectionKisi">
                        <div class="forum2">
                            <div class="row">
                                <form action="resim7.asp" method="POST">
                                    <a href="resim77.asp">Bu resim hakkında  mesaj / yorum ekleyin..  :)</a>    
                                </form>    
                            </div>
                        </div> 
                    </section>
                    <div class="sectionKisi">
                        ...
                        <% 
                            ...
                            sql="select * from resim7"
                            veri.Open "resim7", conn
                        %>
...
<%
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO resim7(tarih,saat,isim,yorum) VALUES('"& tarih & "','"& saat & "','"& isim & "','"& message & "')"
        conn.Execute sql 
    
        conn.Close 
        set conn=Nothing

        response.redirect "resim7.asp"
    end if
%>