    ...
    %>
        ...
        <div id="container">
            ...
            <section>
                ...
                <main>
                    <h1><i class="fas fa-align-left"></i> FORUM SAYFASI </h1>
                    <section class="sectionKisi">
                        <div class="forum2">
                            <div class="row">
                                <form action="forum.asp" method="POST">
                                    <a href="forum1.asp">Forum Sayfasına Mesajınızı Bırakın :)</a>
                                </form>       
                            </div>
                        </div> 
                    </section>
                    <div class="sectionKisi">
                        ...
                        <table class="sectionKisi" width="250px" style="border: 1px solid black; border:collapse;" border="1">
                            <tr class="td">
                                ...
                                <td width="50px" style="border: solid 3px #424370;">ISIM</td>
                                <td width="50px" style="border: solid 3px #424370;">YORUM</td>
...
%>
    ...
    if request.servervariables("REQUEST_METHOD")="POST" then
        ...
        sql="INSERT INTO yorumlar(isim,yorum,saat,tarih) VALUES('"& isim & "','"& message & "','"& saat & "','"& tarih & "')"
        conn.Execute sql 
